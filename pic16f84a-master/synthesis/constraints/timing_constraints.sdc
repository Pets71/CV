...
# Inputs
set_input_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER [get_ports op_code ]
set_input_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER [get_ports reset ]
...
# Outputs
set_output_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER  [get_ports result ]
set_output_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER  [get_ports pc ]
set_output_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER  [get_ports PORTA ]
set_output_delay [expr 0.1*${MASTER_CLK_P}] -clock DSP_MASTER  [get_ports PORTB ]
